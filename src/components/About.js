...
export default function About(props) {
    ...
    let myStyle={
        color: props.mode==='dark'?'white':'rgb(45 115 183)',
        backgroundColor: props.mode==='dark'?'rgb(45 115 183)':'white'
    }
    
    return (
        <div className="container AboutUs-style" style={myStyle}><h2>About Us</h2>
            ...
            {/* <button className="btn btn-primary my-2" onClick={Togglemodes}>{btnText}</button> */}
